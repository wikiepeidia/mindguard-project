...
quiz_questions = [
    ...
    },
    {
        ...
        "options": [
            "Gửi ảnh giấy tờ tùy thân cho admin để được 'xác minh'",
    ...
    {
        "id": 16,
        "question": "Phishing (lừa đảo qua mạng) thường xảy ra qua các kênh nào?",
        "options": [
            "Chỉ qua email",
            "Email, SMS, tin nhắn mạng xã hội và các cuộc gọi thoại",
            "Chỉ qua trang web đen",
    ...
    {
        "id": 17,
        "question": "Deepfake là gì và nó nguy hiểm thế nào trong các vụ lừa đảo?",
        "options": [
            "Một loại virus máy tính mới",
            "Công nghệ giả mạo khuôn mặt và giọng nói của người thân để lừa chuyển tiền qua cuộc gọi video",
            "Một phần mềm chỉnh sửa ảnh đơn giản",
    ...
    {
        "id": 18,
        "question": "Bạn thấy một quảng cáo 'Việc làm tại nhà, lương 500k/giờ, không cần kinh nghiệm' trên Facebook. Đâu là dấu hiệu đáng ngờ?",
        "options": [
            "Việc làm được quảng cáo công khai",
            "Mức lương quá cao so với tính chất công việc đơn giản và yêu cầu nạp tiền để 'giữ chỗ' hoặc 'nhận nhiệm vụ'",
            "Người tuyển dụng có avatar đẹp",
    ...
    {
        "id": 19,
        "question": "Nếu bạn nhận được một email từ 'Bộ Công An' yêu cầu cài đặt ứng dụng để định danh điện tử, bạn nên:",
        "options": [
            "Cài đặt ngay để tuân thủ pháp luật",
            "Không bao giờ cài đặt ứng dụng qua file APK hoặc đường link lạ; cơ quan chức năng không làm việc qua online theo cách này",
            "Chuyển tiếp cho người thân cùng cài",
    ...
    {
        "id": 20,
        "question": "Tuyệt chiêu '3 KHÔNG' để phòng tránh lừa đảo qua mạng là gì?",
        "options": [
            "Không nghe, Không thấy, Không biết",
            "Không sợ, Không nể, Không tha",
            "Không tin ngay, Không vội vàng chuyển tiền, Không cung cấp thông tin cá nhân/OTP khi chưa xác minh",
