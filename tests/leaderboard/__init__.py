"""Test helpers for leaderboard integrity tests.
...
def create_test_app():
    ...
    test_app.config.update({
        'TESTING': True,
        'SECRET_KEY': 'test-secret-key-leaderboard',
...
class LeaderboardTestBase(unittest.TestCase):
    """Base class for leaderboard integrity tests.
